...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      whichHole: 0,
      whichPos: "T",
      initialRegion: { lat: 39.792760, lng: -86.229998 },
  ...
  handleSaveCourseClick = () => {
    ...
    try {
      ...
      // console.log("feat->", Object.keys(theCourse))
      theCourse.Features.forEach(function (p) {
        ...
        if ("noLocationProperties" in p) {
          let z = []
          
          z[0] = utils.convertGeoFromGoogle(p.noLocationProperties.FairwayLocation)
          z[1] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter1)
          z[2] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter2)

          z[3] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter3)
          z[4] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter4)
          z[5] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter5)
          
          z[6] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter6)
          z[7] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter7)
          z[8] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter8)
          z[9] = utils.convertGeoFromGoogle(p.noLocationProperties.fairwayTemplateCenter9)
          
          p.noLocationProperties = z
  ...
  handleSaveHoleConfigClick(holeConfig) {
    ...
    // console.log("sb1-->", this.state.selectedButtons, typeof(this.state.selectedButtons))
    // first make a copy
    let courseCopy = JSON.parse(JSON.stringify(this.state.aCourse))
    ...
    if (holeConfig.properties.TeeLocation === undefined) {
      alert("please place a Tee, a Fairway and a Green before saving!")
      return
    }
    ...
    if (holeConfig.properties.FairwayLocation === undefined) {
      alert("please place a Tee, a Fairway and a Green before saving!")
      return
    }
    ...
    if (holeConfig.properties.FlagLocation === undefined) {
      alert("please place a Tee, a Fairway and a Green before saving!")
      return
    }
    ...
    if (holeConfig.noLocationProperties !== undefined) {
      ...
      geo = utils.completeNo_HoleLocation(holeConfig.properties.FairwayLocation, 'f', 1)

      o.noLocationProperties.fairwayTemplateCenter1 = geo[0]
      o.noLocationProperties.fairwayTemplateCenter2 = geo[1]
      o.noLocationProperties.fairwayTemplateCenter3 = geo[2]

      o.noLocationProperties.fairwayTemplateCenter4 = geo[3]
      o.noLocationProperties.fairwayTemplateCenter5 = geo[4]
      o.noLocationProperties.fairwayTemplateCenter6 = geo[5]

      o.noLocationProperties.fairwayTemplateCenter7 = geo[6]
      o.noLocationProperties.fairwayTemplateCenter8 = geo[7]
      o.noLocationProperties.fairwayTemplateCenter9 = geo[8]
    }
    // save all the course info to the global state
    courseCopy.Features[o.properties.number] = o
    let sb = Object.assign({}, this.state.selectedButtons)
    sb[o.properties.number] = 1

    console.log("sb2-->", sb, typeof(sb))
    this.setState({ aCourse: courseCopy, selectedButtons: sb })
  }
  ...
  handleMapClick(latLng) {
    ...
    switch (this.state.whichPos) {
      case "T": {
        ...
        h.properties.TeeLocation = utils.fillInHoleConfigInfo(geometry, 't')
        // console.log("h-->", h)
      ...
      case "F": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.FlagLocation = utils.fillInHoleConfigInfo(geometry, 'g')
        this.setState({ holeConfig: h })
      ...
      case "L": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.FairwayLocation = utils.fillInHoleConfigInfo(geometry, 'f')
      ...
      case "Tm1": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.teeTemplateCenter1 = utils.fillInHoleConfigInfo(geometry, 'A')
        this.setState({ holeConfig: h })
      ...
      case "Tm2": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.teeTemplateCenter2 = utils.fillInHoleConfigInfo(geometry, 'B')
        this.setState({ holeConfig: h })
      ...
      case "Tm3": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.teeTemplateCenter3 = utils.fillInHoleConfigInfo(geometry, 'C')
        this.setState({ holeConfig: h })
      ...
      case "Tm4": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.teeTemplateCenter4 = utils.fillInHoleConfigInfo(geometry, 'D')
        this.setState({ holeConfig: h })
      ...
      case "Tm5": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.teeTemplateCenter5 = utils.fillInHoleConfigInfo(geometry, 'E')
        this.setState({ holeConfig: h })
      ...
      case "Tm6": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.teeTemplateCenter6 = utils.fillInHoleConfigInfo(geometry, 'F')
        this.setState({ holeConfig: h })
      ...
      case "Fm1": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.greenTemplateCenter1 = utils.fillInHoleConfigInfo(geometry, 'G')
        this.setState({ holeConfig: h })
      ...
      case "Fm2": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.greenTemplateCenter2 = utils.fillInHoleConfigInfo(geometry, 'H')
        this.setState({ holeConfig: h })
      ...
      case "Fm3": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.greenTemplateCenter3 = utils.fillInHoleConfigInfo(geometry, 'I')
        this.setState({ holeConfig: h })
      ...
      case "Fm4": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.greenTemplateCenter4 = utils.fillInHoleConfigInfo(geometry, 'J')
        this.setState({ holeConfig: h })
      ...
      case "Fm5": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.greenTemplateCenter5 = utils.fillInHoleConfigInfo(geometry, 'K')
        this.setState({ holeConfig: h })
      ...
      case "Fm6": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.greenTemplateCenter6 = utils.fillInHoleConfigInfo(geometry, 'L')
        this.setState({ holeConfig: h })
      ...
      case "Lm1": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.fairwayTemplateCenter1 = utils.fillInHoleConfigInfo(geometry, 'M')
        this.setState({ holeConfig: h })
      ...
      case "Lm2": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.fairwayTemplateCenter2 = utils.fillInHoleConfigInfo(geometry, 'N')
        this.setState({ holeConfig: h })
      ...
      case "Lm3": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.fairwayTemplateCenter3 = utils.fillInHoleConfigInfo(geometry, 'O')
        this.setState({ holeConfig: h })
      ...
      case "Lm4": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.fairwayTemplateCenter4 = utils.fillInHoleConfigInfo(geometry, 'P')
        this.setState({ holeConfig: h })
      ...
      case "Lm5": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.fairwayTemplateCenter5 = utils.fillInHoleConfigInfo(geometry, 'Q')
        this.setState({ holeConfig: h })
      ...
      case "Lm6": {
        let h = JSON.parse(JSON.stringify(this.state.holeConfig))
        h.properties.fairwayTemplateCenter6 = utils.fillInHoleConfigInfo(geometry, 'R')
        this.setState({ holeConfig: h })
  ...
  handleHoleButtonClick(indx) {
    ...
    console.log("indx", indx, this.state)
  ...
  render() {
    ...
    for (let j = 0; j < 18; j++) {
      ...
      // the selectedButtons are the ButtonGroup, 1-18
      // stSel is the "info bar" at the bottom of the button panel.
      // it tells you which hole you have completed
