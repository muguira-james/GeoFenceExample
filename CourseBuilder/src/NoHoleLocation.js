...
export default class NoHoleLocation extends React.Component {
  ...
  handleMapClick(latLng) {
    ...
    switch(this.state.whichPos) {
      ...
      case "Lm1": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter1 = utils.fillInHoleConfigInfo(geometry, 'A')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm2": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter2 = utils.fillInHoleConfigInfo(geometry, "B")
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm3": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter3 = utils.fillInHoleConfigInfo(geometry, 'C')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm4": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter4 = utils.fillInHoleConfigInfo(geometry, 'D')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm5": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter5 = utils.fillInHoleConfigInfo(geometry, 'E')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm6": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter6 = utils.fillInHoleConfigInfo(geometry, 'F')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm7": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter7 = utils.fillInHoleConfigInfo(geometry, 'G')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm8": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter8 = utils.fillInHoleConfigInfo(geometry, 'H')
        this.props.handleHoleConfigChange(h)
      ...
      case "Lm9": {
        let h = JSON.parse(JSON.stringify(this.props.holeConfig)) 
        h.noLocationProperties.fairwayTemplateCenter9 = utils.fillInHoleConfigInfo(geometry, 'I')
        this.props.handleHoleConfigChange(h)
